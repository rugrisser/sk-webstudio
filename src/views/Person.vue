            ...
            return {
                ...
                persons: [
                    ...
                    new Person('/img/employees/12.jpg',
                        'Вячеслав Рыжков',
                        'Разработчик',
                        '«Просто оно у меня хорошо получается, поэтому и занимаюсь им», - так говорит о программировании Вячеслав. Казалось бы, чего в этом необычного? Ответ прост - это его стиль. Простота - это его стихия. Только ему под силу преобразить замудренное и загруженное ТЗ в тот продукт, который зайдет любому привередливому заказчику:)',
                        ['web', 'android', 'back-end', 'parsing', 'dezign', 'верстка'],
                        true,
                        [[['', ''], ['', '']], [['', ''], ['','']]],
                        false,
                        ['НТИ Большие данные и машинное обучени', 'Финалист МОШ', '8 литров Red Bull\'а'],
