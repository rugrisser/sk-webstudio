<template>
    <div class="person" id="main">
        <div class="screenError">
            <p>Данная версия сайта находится в стадии разработки :(</p>
            <p>Познакомиться с нами можно через браузер на Вашем ПК или ноутбуке. Мы Вас ждем!</p>
        </div>
            ...
            <div class="left_information">
                ...
                <div class="skills_style">
                    <p class="competences_style">Навыки:</p>
                        <div v-for="(competence2, index) in persons[id].skills"
            ...
            return {
                ...
                persons: [
                    ...
                    new Person('',
                        ...
                        [['web', 'android', 'back-end'], ['parsing', 'dezign', 'front-end'], ['database', 'javascript', 'python'], ['java', 'c#', 'c++'], ['php']],
                        true,
                        [[['', ''], ['', '']], [['', ''], ['','']]],
                        false,
